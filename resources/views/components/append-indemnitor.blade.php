    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-6 mt-2 mb-2">
                <label for="personal_indemnitor" class="form-label ">  Personal Indemnitor(s) {{$itemCount+1}}<span class="req text-danger">*</span></label>
                <textarea name="indemnitors[{{$itemCount}}][personal]" class="form-control" rows="2" required='required'> {{$indemnitor->personal??''}} </textarea>
            </div>
            <div class="col-6 mt-2 mb-2">
                <label for="corporate" class="form-label w-100">   Corporate Indemnitor(s) {{$itemCount+1}}<span class="req text-danger">*</span>
