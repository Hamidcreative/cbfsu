<x-custom-modal-component>
    <x-slot name="title">
        {{ __('Review & Approve Bid Bond Document') }}
    </x-slot>
    <style>
        .fixed-tab {
        ...
        .btn-like {
            ...
            background-color: #007bff; /* Bootstrap primary color or your preferred color */
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                @else
                                                    ...
                                                    {{--                                        <img src="{{ asset('images/bonds/' . $bond_detail->attachment) }}" alt="Attachment" style="width: 100%; height: 80%; display: block;">--}}
                                                @endif
{{--                                                <p class="text-muted mb-0"> {{$bond_detail->bid_start_date ?? ''}}  </p>--}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-3 mb-3" style="float: right">
                                            <form id="issue-docs-form" method="post" action="{{ route('bond.issue-docs',mws_encrypt('E',$bond_detail->id)) }}">
                                                @csrf
                                                <button class="form_submit hidden btn btn-success">
                                                    Review & Approve Bid Bond Documents
                                                </button>
                                            </form>
                                            <button class="btn btn-primary modal_submits"> Review & Approve Bid Bond Documents </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.modal_submits', function(e) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "Do you Want to Approve & Issue Bid Bond Documents to the Customer against the Bond?",
                icon: 'warning',
