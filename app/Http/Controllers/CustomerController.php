...
//            'questions.*'           => 'required',
        ...
        $customerData = [
            ...
            'phone'               => $request['phone'],
            'average_size'        => amountFormatReverse($request['average_size']),
            'largest_size'        => amountFormatReverse($request['largest_size']),
            'backlog'             => amountFormatReverse($request['backlog']),
        ...
        $authority_data = [
            ...
            'single_job_limit' =>    amountFormatReverse($request['single_limt']),
            'aggregate_limit'  =>    amountFormatReverse($request['aggr_limt']),
